export const showToast = (message, type = 'error') => {
  ...
  toast.className = `flex items-center gap-3 px-4 py-3 text-white rounded-xl shadow-lg transform transition-all duration-300 translate-y-10 opacity-0 ${bgColor} pointer-events-auto`;
